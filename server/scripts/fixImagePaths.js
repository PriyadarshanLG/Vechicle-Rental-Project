...
// Mapping of bike names to their exact image file names (case-sensitive)
const bikeImageMap = {
...
// Connect to MongoDB and update bike images with proper encoding
